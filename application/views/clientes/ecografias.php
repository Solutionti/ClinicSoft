      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Ecografias</li>
          </ol>
          <h6 class="font-weight-bolder text-white mb-0">Ecografias</h6>
        </nav>
    ...
    <div class="card shadow-lg mx-4 mt-5">
      <div class="card-body p-3">
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-6">
              <h5 class="text-primary">Ecografia de mama</h5>
              <div class="col-md-6 mt-4">
                <a href="">
                  <i class="fas fa-file-pdf fa-3x text-danger"></i>
                  <small> <?php echo date("d-m-Y"); ?></small>
                  <h6>Ecografia de bebe</h6>
                  Ver pdf
                </a>
              </div>
            </div>
            ...
            <div class="col-md-6">
              <h5 class="text-primary">Ecografia transvaginal</h5>
              <div class="col-md-6 mt-4">
                <a href="">
                  <i class="fas fa-file-pdf fa-3x text-danger"></i>
                  <small> <?php echo date("d-m-Y"); ?></small>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-6">
              <h5 class="text-primary">Ecografia Pelvica</h5>
              <div class="col-md-6 mt-4">
                <a href="">
                  <i class="fas fa-file-pdf fa-3x text-danger"></i>
                  <small> <?php echo date("d-m-Y"); ?></small>
            ...
            <div class="col-md-6">
              <h5 class="text-primary">Ecografia Morfologica</h5>
              <div class="col-md-6 mt-4">
                <a href="">
                  <i class="fas fa-file-pdf fa-3x text-danger"></i>
                  <small> <?php echo date("d-m-Y"); ?></small>
