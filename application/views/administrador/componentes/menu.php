<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
   <div class="sidenav-header">
      ...
      <img src="https://img.freepik.com/vector-premium/diseno-logotipo-clinica-medica-concepto-creativo-unico_526458-2787.jpg?semt=ais_hybrid&w=740" class="navbar-brand-img h-100" alt="main_logo">
      <span class="ms-1 font-weight-bold">ClinicSoft<small class="text-primary">Colombia</small></span>
      </a>
   </div>
