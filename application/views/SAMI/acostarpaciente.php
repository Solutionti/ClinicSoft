      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Acostar Paciente</li>
          </ol>
          <h6 class="font-weight-bolder text-white mb-0">Acostar Paciente</h6>
        </nav>
      ...
      <div class="card-body p-3">
        <div class="row gx-4">
          ...
          <div class="col-auto my-auto">
            <div class="h-100">
              <h5 class="mt-3">Acostar Pacientes</h5>
              <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Ver todos los acostados</button>
            </div>
          </div>
        </div>
        <br>
