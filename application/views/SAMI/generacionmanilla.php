...
<head>
    ...
    <title>Generacion de manilla QR</title>
  ...
  <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="false">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Generar manillas</li>
          </ol>
          <h6 class="font-weight-bolder text-white mb-0">Generar manillas</h6>
        </nav>
      ...
      <div class="card-body p-3">
        <div class="row gx-4">
          ...
          <div class="col-auto my-auto">
            <div class="h-100">
              <h5 class="mt-3">Internar Pacientes</h5>
              <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Ver todos los internos</button>
            </div>
          </div>
        </div>
        <br>
    ...
    <div class="modal-content">
      <div class="modal-header bg-default">
        <h1 class="modal-title fs-5 text-white" id="staticBackdropLabel">PACIENTES ACOSTADOS</h1>
